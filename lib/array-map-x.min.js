 ...
 * @module array-map-x
 */
"use strict";var isWorking,cachedCtrs=_dereq_("cached-constructors-x"),ArrayCtr=cachedCtrs.Array,castObject=cachedCtrs.Object,nativeMap="function"==typeof ArrayCtr.prototype.map&&ArrayCtr.prototype.map;if(nativeMap){var attempt=_dereq_("attempt-x"),spy=0,res=attempt.call([1,2],nativeMap,function(item){return item});if((isWorking=!1===res.threw&&res.value&&2===res.value.length&&1===res.value[0]&&2===res.value[1])&&(spy="",isWorking=!1===(res=attempt.call(castObject("ab"),nativeMap,function(item){return item})).threw&&res.value&&2===res.value.length&&"a"===res.value[0]&&"b"===res.value[1]),isWorking&&(spy=0,isWorking=!1===(res=attempt.call(function(){return arguments}(1,2),nativeMap,function(item){return item})).threw&&res.value&&2===res.value.length&&1===res.value[0]&&2===res.value[1]),isWorking&&(spy=0,isWorking=!1===(res=attempt.call({0:1,2:2,length:3},nativeMap,function(item){return item})).threw&&res.value&&3===res.value.length&&1 in res.value==!1),isWorking){var doc="undefined"!=typeof document&&document;if(doc){spy=null;var fragment=doc.createDocumentFragment(),div=doc.createElement("div");fragment.appendChild(div),isWorking=!1===(res=attempt.call(fragment.childNodes,nativeMap,function(item){return item})).threw&&res.value&&1===res.value.length&&res.value[0]===div}}if(isWorking){(function(){return!1===Boolean(this)})()&&(spy=null,isWorking=!1===(res=attempt.call([1],nativeMap,function(){spy="string"==typeof this},"x")).threw&&res.value&&1===res.value.length&&!0===spy)}if(isWorking){spy={};var fn=['return nativeMap.call("foo", function (_, __, context) {','if (Boolean(context) === false || typeof context !== "object") {',"spy.value = true;}});"].join("");isWorking=!1===(res=attempt(Function("nativeMap","spy",fn),nativeMap,spy)).threw&&res.value&&3===res.value.length&&!0!==spy.value}}var $map;if(nativeMap)$map=function map(array,callBack){var args=[callBack];return arguments.length>2&&(args[1]=arguments[2]),nativeMap.apply(array,args)};else{var splitIfBoxedBug=_dereq_("split-if-boxed-bug-x"),toLength=_dereq_("to-length-x").toLength2018,isUndefined=_dereq_("validate.io-undefined"),toObject=_dereq_("to-object-x"),assertIsFunction=_dereq_("assert-is-function-x");$map=function map(array,callBack){var object=toObject(array);assertIsFunction(callBack);var thisArg,iterable=splitIfBoxedBug(object),length=toLength(iterable.length);arguments.length>2&&(thisArg=arguments[2]);var noThis=isUndefined(thisArg),result=[];result.length=length;for(var i=0;i<length;i+=1)if(i in iterable){var item=iterable[i];result[i]=noThis?callBack(item,i,object):callBack.call(thisArg,item,i,object)}return result}}module.exports=$map},{"assert-is-function-x":2,"attempt-x":3,"cached-constructors-x":4,"split-if-boxed-bug-x":27,"to-length-x":30,"to-object-x":32,"validate.io-undefined":40}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isFunction=_dereq_("is-function-x"),safeToString=_dereq_("to-string-symbols-supported-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsFunction(callback){if(!1===isFunction(callback)){var msg=isPrimitive(callback)?safeToString(callback):"#<Object>";throw new TypeError(msg+" is not a function")}return callback}},{"is-function-x":12,"is-primitive":15,"to-string-symbols-supported-x":34}],3:[function(_dereq_,module,exports){/**
 ...
 * @module is-falsey-x
 */
"use strict";var toBoolean=_dereq_("to-boolean-x");module.exports=function isFalsey(value){return!1===toBoolean(value)}},{"to-boolean-x":28}],11:[function(_dereq_,module,exports){/**
 ...
 * @module is-finite-x
 */
"use strict";var numberIsNaN=_dereq_("is-nan-x"),INFINITY=_dereq_("infinity-x");module.exports=function isFinite(number){return"number"==typeof number&&!1===numberIsNaN(number)&&number!==INFINITY&&number!==-INFINITY}},{"infinity-x":8,"is-nan-x":13}],12:[function(_dereq_,module,exports){/**
 ...
 * @module nan-x
 */
"use strict";module.exports=NaN},{}],22:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x"),toStr=_dereq_("to-string-x");module.exports=function requireCoercibleToString(value){return toStr(requireObjectCoercible(value))}},{"require-object-coercible-x":26,"to-string-x":36}],26:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":14}],27:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var strSplit,isString;!1===_dereq_("has-boxed-string-x")&&(isString="function"==typeof(strSplit="".split)&&_dereq_("is-string")),module.exports=function splitIfBoxedBug(value){return isString&&isString(value)?strSplit.call(value,""):value}},{"has-boxed-string-x":5,"is-string":16}],28:[function(_dereq_,module,exports){/**
 ...
 * @module to-boolean-x
 */
"use strict";module.exports=function toBoolean(value){return!!value}},{}],29:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var libToInteger=_dereq_("to-integer-x"),toInteger2016=libToInteger.toInteger2016,toInteger2018=libToInteger.toInteger2018,MAX_SAFE_INTEGER=_dereq_("max-safe-integer"),$toLength2018=function toLength2018(value){var len=toInteger2018(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len};module.exports={toLength:$toLength2018,toLength2016:function toLength2016(value){var len=toInteger2016(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len},toLength2018:$toLength2018}},{"max-safe-integer":20,"to-integer-x":29}],31:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x"),castObject=_dereq_("cached-constructors-x").Object;module.exports=function toObject(value){return castObject(requireObjectCoercible(value))}},{"cached-constructors-x":4,"require-object-coercible-x":26}],33:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr={}.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":18,"validate.io-undefined":40}],36:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var castString="".constructor,isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return castString(value)}},{"is-symbol":17}],37:[function(_dereq_,module,exports){/**
 ...
 * @module trim-right-x
 */
"use strict";var requireCoercibleToString=_dereq_("require-coercible-to-string-x"),Rx=_dereq_("cached-constructors-x").RegExp,reRight2016=new Rx("["+_dereq_("white-space-x").string2016+"]+$"),reRight2018=new Rx("["+_dereq_("white-space-x").string2018+"]+$"),replace="".replace,$trimRight2018=function trimRight2018(string){return replace.call(requireCoercibleToString(string),reRight2018,"")};module.exports={trimRight:$trimRight2018,trimRight2016:function trimRight2016(string){return replace.call(requireCoercibleToString(string),reRight2016,"")},trimRight2018:$trimRight2018}},{"cached-constructors-x":4,"require-coercible-to-string-x":25,"white-space-x":41}],39:[function(_dereq_,module,exports){/**
