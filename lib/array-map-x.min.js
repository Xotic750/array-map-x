 ...
 * @module array-map-x
 */
"use strict";var toObject=_dereq_("to-object-x"),assertIsFunction=_dereq_("assert-is-function-x"),some=_dereq_("array-some-x"),toLength=_dereq_("to-length-x");module.exports=function map(array,callBack){var object=toObject(array);assertIsFunction(callBack);var result=new Array(toLength(toObject.length)),args=[object,function _wrapped(item,idx,obj){result[idx]=callBack.call(this,item,idx,obj)}];return arguments.length>2&&args.push(arguments[2]),some.apply(void 0,args),result}},{"array-some-x":2,"assert-is-function-x":3,"to-length-x":26,"to-object-x":27}],2:[function(_dereq_,module,exports){/**
 ...
 * @module array-some-x
 */
"use strict";var boxedString=Object("a"),splitString="a"!==boxedString[0]||0 in boxedString==!1,isStrict=function(){return!1===Boolean(this)}(),properlyBoxesNonStrict=!0,properlyBoxesStrict=!0,nativeSome=Array.prototype.some;if(nativeSome)try{isStrict?nativeSome.call([1],function(){properlyBoxesStrict="string"==typeof this},"x"):nativeSome.call("foo",function(_,__,context){!1!==Boolean(context)&&"object"==typeof context||(properlyBoxesNonStrict=!1)})}catch(e){nativeSome=null}var $some;if(nativeSome&&properlyBoxesNonStrict&&properlyBoxesStrict)$some=function some(array,callBack){var args=[callBack];return arguments.length>2&&args.push(arguments[2]),nativeSome.apply(array,args)};else{var toObject=_dereq_("to-object-x"),assertIsFunction=_dereq_("assert-is-function-x"),isString=_dereq_("is-string"),toLength=_dereq_("to-length-x"),isUndefined=_dereq_("validate.io-undefined");$some=function some(array,callBack){var object=toObject(array);assertIsFunction(callBack);var thisArg,iterable=splitString&&isString(object)?object.split(""):object,length=toLength(iterable.length);arguments.length>2&&(thisArg=arguments[2]);for(var i=0;i<length;i+=1)if(i in iterable){if(isUndefined(thisArg)?callBack(iterable[i],i,object):callBack.call(thisArg,iterable[i],i,object))return!0}return!1}}module.exports=$some},{"assert-is-function-x":3,"is-string":16,"to-length-x":26,"to-object-x":27,"validate.io-undefined":29}],3:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isSymbol=_dereq_("is-symbol"),pToString=_dereq_("has-symbol-support-x")&&Symbol.prototype.toString;module.exports=function safeToString(value){return pToString&&isSymbol(value)?pToString.call(value):String(value)}},{"has-symbol-support-x":6,"is-symbol":17}],25:[function(_dereq_,module,exports){/**
 ...
 * @module to-integer-x
 */
"use strict";var $isNaN=_dereq_("is-nan"),$isFinite=_dereq_("is-finite-x"),$sign=_dereq_("math-sign-x");module.exports=function ToInteger(value){var number=Number(value);return $isNaN(number)?0:0===number||!1===$isFinite(number)?number:$sign(number)*Math.floor(Math.abs(number))}},{"is-finite-x":8,"is-nan":11,"math-sign-x":19}],26:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var $requireObjectCoercible=_dereq_("require-object-coercible-x");module.exports=function ToObject(value){return Object($requireObjectCoercible(value))}},{"require-object-coercible-x":23}],28:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":18,"validate.io-undefined":29}],29:[function(_dereq_,module,exports){"use strict";module.exports=function isUndefined(value){return void 0===value}},{}]},{},[1])(1)});